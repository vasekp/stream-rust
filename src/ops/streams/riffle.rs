...
mod tests {
    ...
    fn test_riffle() {
        ...
        assert_eq!(parse("seq.riffle(seq + 3)").unwrap().eval_default().unwrap().to_string(), "[1, 4, 2, 5, 3, ...]");
        assert_eq!(parse("0.repeat.riffle(1)").unwrap().eval_default().unwrap().to_string(), "[0, 1, 0, 1, 0, ...]");
        assert_eq!(parse("[1,2,3].riffle('a')").unwrap().eval_default().unwrap().to_string(), "[1, 'a', 2, 'a', 3]");
        assert_eq!(parse("seq.riffle(['a'])").unwrap().eval_default().unwrap().to_string(), "[1, 'a', 2]");
        ...
        test_len_exact(&parse("[1,2,3].riffle([])").unwrap().eval_default().unwrap(), 1);
        ...
        test_skip_n(&parse("seq.riffle(0)").unwrap().eval_default().unwrap());
        test_skip_n(&parse("range(100).riffle(seq)").unwrap().eval_default().unwrap());
        test_skip_n(&parse("range(100).riffle(0)").unwrap().eval_default().unwrap());
        test_skip_n(&parse("range(100).riffle(range(50))").unwrap().eval_default().unwrap());
        test_skip_n(&parse("range(100).riffle(range(99))").unwrap().eval_default().unwrap());
        test_skip_n(&parse("range(100).riffle(range(100))").unwrap().eval_default().unwrap());
        test_skip_n(&parse("range(100).riffle(range(101))").unwrap().eval_default().unwrap());
        test_skip_n(&parse("range(100).riffle(range(200))").unwrap().eval_default().unwrap());
        test_skip_n(&parse("range(100).riffle([])").unwrap().eval_default().unwrap());
        test_skip_n(&parse("[].riffle(range(3))").unwrap().eval_default().unwrap());
        test_skip_n(&parse("[].riffle(range(1))").unwrap().eval_default().unwrap());
        test_skip_n(&parse("[].riffle([])").unwrap().eval_default().unwrap());
        assert_eq!(parse("seq.riffle(['a'])").unwrap().eval_default().unwrap().describe(), "seq.riffle(['a'])");
    }
}
